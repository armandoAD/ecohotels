			...
			<header class="entry-header">
				<section class="entry-header-title">
					...
					<ul>             		
							...
							<a href="mailto:<?php echo $email; ?>" class="entry-email frontend_email listing_custom" <?php if($is_edit==1):?>contenteditable="true"<?php endif;?>><i class="fa fa-envelope"></i><?php _e('Email','templatic');?></a>
							<?php endif; ?>
							</li>
		...
		<section class="entry-content">
			<?php do_action('directory_before_post_content');	?>
					...
					jQuery(function() {
						...
						jQuery('.listing-image .slides li a').lightBox();
					});	
					</script><?php
					...
					<dl class="tmpl-accordion" data-accordion>
							...
							<?php if(@$tmpdata['direction_map']=='yes' && $listing_address && @$tmpdata['google_map_show']=='No'):?>									
