...
function templatic_general_setting_register_data($column){
	...
	?>
		...
		<tr>
		<th><label><?php echo __('Show Dashboard Bar','templatic-admin');  ?></label></th>
		<td>
			<div class="input-switch"><input type="checkbox" id="show_dashboard_bar" name="show_dashboard_bar" value="1" <?php if(isset($tmpdata['show_dashboard_bar']) && @$tmpdata['show_dashboard_bar']==1){?>checked="checked"<?php }?> />
			<label for="show_dashboard_bar">&nbsp;<?php echo __('Enable','templatic-admin');?></label></div>
			<p class="description"><?php echo __('Disabling this option will hide dashboard bar.','templatic-admin'); ?></p>
		</td>
		</tr>
