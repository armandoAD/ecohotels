...
jQuery(document).ready(function(){
	...
	if(jQuery('#featured_h').length > 0 || jQuery('#featured_c').length > 0 ) 
	{
		...
		jQuery(document).on('change','#featured_h', function() {
		...
		jQuery(document).on('change','#featured_c', function() {
	...
	jQuery(document).on('change',".category_label input[name^='category'], .category_label input[name='selectall'],.category_label select[name^='category']", function() {
		
		/* for all check box check or not */
		jQuery(document).on('change',"#submit_form input[name^='category']",function(){
