...
<div id="icon-edit" class="icon32 icon32-posts-post"><br></div>
	...
	<div class="tevolution_normal">
		<div id="poststuff">
			<div class="postbox">
				<h3 class="transaction_title"><span><?php _e('Transaction Report','templatic'); ?></span></h3>
				<div class="transaction_detail_page">
					<div  class="order_frm">
						<h3  class="transaction_title"><?php _e('Transaction Detail','templatic'); ?></h3>
						<div class="inside">
		...
		<?php if($orderinfoObj->payforpackage == 0 || $orderinfoObj->payforpackage == 1): ?>
			<div id="poststuff">
				<div class="postbox">
					<h3 class="transaction_title"><span><?php 
		...
		<div class="tevolution_side">
			<div id="poststuff">
				<div class="postbox">
					<h3 class="transaction_title"><span><?php _e('Transaction Status','templatic'); ?></span></h3>
					<div class="inside">
						<p class="stat">
