...
if(!function_exists('preview_address_google_map'))
{
	...
	$taxonomies = get_object_taxonomies( (object) array( 'post_type' => get_post_type($_REQUEST['pid']),'public'   => true, '_builtin' => true ));	
	$post_categories = get_the_terms( $_REQUEST['pid'] ,$taxonomies[0]);
