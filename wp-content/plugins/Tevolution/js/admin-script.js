...
function ShowHideSearch_ctypeOption(value){		
		...
		if(value=='text' || value=='textarea' || value=='texteditor' || value=='geo_map'){
			...
			jQuery('select#search_ctype option').each(function(){				
				if(jQuery(this).val()=='text' || (value=='text' && jQuery(this).val()=='select') ){
					jQuery(this).prop('disabled', false);
				}else{
					jQuery(this).prop('disabled', true);
				}
	...
	**/
	jQuery('.buttons .quick_save').click(function(){
		...
		**/
		...
		if(jQuery("#pre_payment_success_email_content_to_user").css("display") == "none"){
			jQuery("#pre_payment_success_email_content_to_user").val(tinyMCE.get('pre_payment_success_email_content_to_user').getContent());
		}
		...
		if(jQuery("#update_listing_notification_admin_content").css("display") == "none"){
			jQuery("#update_listing_notification_admin_content").val(tinyMCE.get('update_listing_notification_admin_content').getContent());
		}
		...
		**/
		...
		jQuery.ajax({
			...
			success:function(results) {
				...
				/* Show hide registration email tr*/
				jQuery('.edit-pre-payment-success-user').css({'display':'none'});
				jQuery('.pre-payment-success-user').css({'display':'table-row'});
				/* Show hide registration email tr*/
				...
				/* Show hide update listing admin notification email tr*/				
				jQuery('.edit-update-listing-notification-admin').css({'display':'none'});
				jQuery('.update-listing-notification-admin').css({'display':'table-row'});
				...
				/* Show hide pending listing notification email tr*/				
				jQuery('.edit-deal-voucher-text').css({'display':'none'});
				jQuery('.deal-voucher-text').css({'display':'table-row'});
				
				
				/* Display changes instantly */
				//alert(results.action);
				if (typeof hide_custom_notification == 'function')
				{ 
					hide_custom_notification();
				}
