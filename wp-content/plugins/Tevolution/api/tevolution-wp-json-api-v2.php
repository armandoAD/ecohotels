...
/* get_event_calendar_widget_datewise */
...
/* get_all_categories_list_widget */
...
/* 
function get_tevolution_post_type(WP_REST_Request $request) {
	echo 'ddddddddddddd'; die;
} */


/* get_city_type_category */
...
function get_recent_review_comments($filter = array()){
...
function get_event_calendar_widget_datewise($filter = array()){
...
function get_all_categories_list_widget($filter = array()){
	global $current_cityinfo;
