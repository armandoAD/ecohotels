		 ...
		 while ( have_posts() ) : the_post();						
			...
			<?php do_action( 'open_entry' ); 
				...
				?>
			     ...
			     <!-- .entry-content -->
				<?php
				apply_filters('supreme_single_categories',supreme_get_categories(__('Categories: ','templatic'),'category','',__('Tags: ','templatic'),'post_tag')); // 1- category label, 2- category slug,3- class name of div, 3- tags label,4- tags slug
