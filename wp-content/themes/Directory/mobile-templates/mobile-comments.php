...
if ( post_password_required() || ( !have_comments() && !comments_open() && !pings_open() ) )
	...
	<dd class="tmpl-accordion-navigation">
		...
		if(get_option('default_comment_status') =='open'){
			echo "<a href='#respond-fr'>".__('Add Review','templatic')."</a>";
	...
	{
		echo "<a id= 'reviews-click' href='#comment-list'>"; templatic_comments_number( __( 'No Comment', 'templatic' ), __( 'One Comment', 'templatic' ), __( 'Comments', 'templatic' )); echo "</a>";
	}
	else
	{
		echo "<a id= 'reviews-click' href='#comment-list'>"; templatic_comments_number( __( 'No Review', 'templatic' ), __( 'One Review', 'templatic' ), __( 'Reviews', 'templatic' ) ); echo "</a>";
	}
