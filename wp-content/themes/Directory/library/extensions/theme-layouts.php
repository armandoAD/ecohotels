...
function theme_layouts_strings() {
	...
	$strings = array(
		'default' => 	__( 'Default', 'templatic' ),
		'1c' => 		__( 'One Column', 'templatic' ),
		'2c-l' => 		__( 'Two Columns, Left', 'templatic' ),
		'2c-r' => 	__( 'Two Columns, Right', 'templatic' ),
		'3c-l' => 		__( 'Three Columns, Left', 'templatic' ),
		'3c-r' => 	__( 'Three Columns, Right', 'templatic' ),
		'3c-c' => 	__( 'Three Columns, Center', 'templatic' )
	);
