...
if(isset($_POST['theme_options_nonce']) && $_POST['theme_options_nonce'] !=''){
	if ( wp_verify_nonce( @$_POST['theme_options_nonce'], basename(__FILE__) ) ){
		...
		wp_die(__("You do not have permission to edit theme settings.",'templatic-admin'));
	}
}
/*
...
<div class="wrap">
  <form name="theme_options_settings" id="theme_options_settings" method="post" enctype="multipart/form-data">
    ...
    <h2>
      <?php echo __("Theme Settings",'templatic-admin');?>
    </h2>  
    ...
    <div class="updated" id="message" style="clear:both">
      <p>
        <?php echo __("Theme Settings",'templatic-admin');?>
        <strong>
        <?php echo __("saved",'templatic-admin');?>
        </strong>.</p>
    </div>
    <?php }?>
    ...
    <div class="wp-filter tev-sub-menu" >
		<ul id="tev_theme_settings" class="filter-links">
			<li class="general_settings active"><a id="general_settings" href="javascript:void(0);" class="current">
				<?php echo __("General Settings",'templatic-admin');?>
			</a> </li>
			<li class="listing_settings active"><a id="listing_settings" href="javascript:void(0);">
				<?php echo __("Category/Tag Archive Page Settings",'templatic-admin');?>
			</a> </li>
			<li class="detail_settings "><a id="detail_settings" href="javascript:void(0);" >
				<?php echo __("Comments Settings",'templatic-admin');?>
			</a> </li>
		</ul>
    </div>
      ...
      <tbody>
        ...
        <tr>
          <th><label for="supreme_global_layout">
              <?php echo __('Global layout','templatic-admin');?>
            </label></th>
          <td><div class="element">
              <select style="vertical-align:top;width:200px;" name="supreme_global_layout" id="supreme_global_layout">
                ...
                <?php echo __("Default Layout",'templatic-admin');?>
                </option>
                <option value="layout_1c" <?php echo ($theme_settings['supreme_global_layout']=='layout_1c') ? 'selected' : ''?>>
                <?php echo __("One Column",'templatic-admin');?>
                </option>
                <option value="layout_2c_l" <?php echo ($theme_settings['supreme_global_layout']=='layout_2c_l') ? 'selected' : ''?>>
                <?php echo __("Two Columns, Left",'templatic-admin');?>
                </option>
                <option value="layout_2c_r" <?php echo ($theme_settings['supreme_global_layout']=='layout_2c_r') ? 'selected' : ''?>>
                <?php echo __("Two Columns, Right",'templatic-admin');?>
                </option>
              </select>
            </div>
            <p class="description">
              <?php echo __("This setting can be overwritten by layout settings within individual posts/pages.",'templatic-admin');?>
            </p></td>
        </tr>
      
		<tr>
          <th><label for="rtlcss">
              <?php echo __("Right-to-Left (RTL) text orientation",'templatic-admin');?>
            </label></th>
          <td>
			<div class="input-switch">
				<input type="checkbox"  value="1" <?php echo (@$theme_settings['rtlcss']==1) ? 'checked' : ''?> id="rtlcss" name="rtlcss">
				<label for="rtlcss">
					<?php echo __('Enable','templatic-admin');?>
				</label>
            </div>
            <p class="description">
        ...
        <tr>
          <th><label for="enable_sticky_header_menu">
              <?php echo __('Sticky header','templatic-admin');?>
            </label></th>
          <td>
			<div class="input-switch">
            ...
            <p class="description">
              <?php echo __('Sticky header is a persistent navigation bar that continues to show even when you scroll down the page.','templatic-admin');?>
            </p></td>
        </tr>
        ...
        <tr>
			<th>
				<label for="supreme_show_breadcrumb">
					<?php echo __('Breadcrumbs','templatic-admin');?>
				</label>
			</th>
			<td>
			<div class="input-switch">
         ...
         <tr>
			<th>
				<label for="supreme_show_breadcrumb">
					<?php echo __('Mobile app view','templatic-admin');?>
				</label>
			</th>
			<td>
			<div class="input-switch">
        ...
        <tr>
          <th><label for="supreme_gogle_analytics_code">
              <?php echo __('Google Analytics tracking code','templatic-admin');?>
            </label></th>
          <td><div class="element">
            ...
            <p class="description">
              <?php echo __("Enter the analytics code you received from GA or some other analytics software. e.g. <a href='https://www.google.co.in/analytics/'>Google Analytics</a>",'templatic-admin');?>
            </p></td>
        </tr>
		<tr>
	...
	<table id="listing_settings" class="tmpl-theme_settings form-table">
        ...
        <tr>
          <th><label for="supreme_display_image">
              <?php echo __('Display excerpts','templatic-admin');?>
            </label></th>
			<td><div class="input-switch">
              ...
              <label for="supreme_archive_display_excerpt">
				...
				<p class="description"><?php echo __("Enable this option to display <a href='http://codex.wordpress.org/Excerpt'>excerpts*</a> instead of the full post description on category pages.",'templatic-admin');?></p>
				</div>
			</td>
        </tr>
        <tr>
          ...
          <td><div class="element">
            ...
            <p class="description">
              <?php echo __('Enter the number of words that should be displayed from your post description. This option can be overwritten by entering the actual excerpt for the post.','templatic-admin');?>
            </p></td>
        </tr>
        <tr>
          <th><label for="templatic_excerpt_link">
              <?php echo __('Read more link name','templatic-admin');?>
            </label></th>
          <td><div class="element">
            ...
            <p class="description">
              <?php echo __('Default link name is "Read More".','templatic-admin');?>
            </p></td>
        </tr>
		<tr>
          <td colspan="2"><p style="clear: both;" class="submit">
	...
	<table id="detail_settings" class="tmpl-theme_settings form-table">
        ...
        <tr>
          <th><label for="enable_comments_on_page">
              <?php echo __('Display comments on WordPress pages','templatic-admin');?>
            </label></th>
          <td><div class="input-switch">
		...
		<tr>
		  <th><label for="enable_comments_on_page">
              <?php echo __('Display comments on posts','templatic-admin');?>
            </label></th>
			 <td><div class="input-switch">
			  ...
			  <p class="description"><?php echo __("This option affects all posts on the site, including any custom post types that you created.",'templatic-admin');?></p>
            </div></td>
        </tr>
        <tr>
          <td colspan="2"><p style="clear: both;" class="submit">
