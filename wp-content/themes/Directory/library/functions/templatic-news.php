...
function TemplaticDashboardWidgetSetup() {
	...
	if(is_super_admin($current_user->ID)) {
		add_meta_box( 'templatic_dashboard_news_widget', __('News From Templatic','templatic-admin'), 'TemplaticDashboardWidgetFunction', 'dashboard', 'normal', 'high' );
	}
}
...
<div class="table table_tnews">
  <p class="sub"><strong>
    <?php echo __('Templatic News','templatic-admin'); ?>
    </strong></p>
...
<div class="t_theme">
  ...
  <hr/>
  <p class="sub"><strong>
    <?php echo __('More...','templatic-admin'); ?>
    </strong></p>
  <ul id="templatic-services">
    <li><a href="http://templatic.com/support"><?php echo __('Need support?','templatic-admin');?> </a></li>
    <li><a href="http://templatic.com/free-theme-install-service/"><?php echo __('Custom services','templatic-admin');?></a></li>
    <li><a href="http://templatic.com/premium-themes-club"><?php echo __('Join our theme club','templatic-admin');?></a></li>
  </ul>
</div>
