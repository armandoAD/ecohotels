...
if(!class_exists('supreme_flickr_Widget'))
{
	class supreme_flickr_Widget extends WP_Widget
	{
		...
		{
			//Constructor
			$widget_ops = array('classname'  => 'flicker_photos ','description'=> __('Showcase your Flickr photos using this simple widget. Works best in sidebar areas.','templatic-admin') );
			parent::__construct('flicker_Widget', __('T &rarr; Flickr Photos','templatic-admin'), $widget_ops);
		}
		function widget($args, $instance)
		{
			...
			$desc = empty($instance['desc']) ? __("The Beautiful Natural Scenery Photos",'templatic') : apply_filters('widget_desc', $instance['desc']);
		...
		function form($instance)
		{
			...
			$instance = wp_parse_args( (array) $instance, array('title'=> __("Photos From Flickr",'templatic'),'desc' => __("The Beautiful Natural Scenery Photos",'templatic'), 'flicker_id' => '73963570@N00', 'flicker_number' => 8 ) );
			?>
		<p>
		...
		<p>
		  <label for="<?php echo $this->get_field_id('desc'); ?>">
			<?php echo __('Description:','templatic-admin');?>
		...
		<p>
		  <label for="<?php echo @$this->get_field_id('flicker_id'); ?>">
			<?php echo __('Flickr ID:','templatic-admin');?>
		...
		<p>
		  <label for="<?php echo @$this->get_field_id('flicker_number'); ?>">
			<?php echo __('Number of photos:','templatic-admin');?>
	...
	class supreme_widget_archives extends WP_Widget
	{
		...
		*/
		function __construct()
		{
			...
			$widget_options = array(
				'classname'  => 'archives',
				'description'=> esc_html(__( 'An advanced widget that gives you total control over the output of your archives.', 'templatic-admin' ))
			);
			...
			parent::__construct(
				...
				__( 'Archives', 'templatic-admin' ),	// $this->name
		...
		*/
		function form( $instance )
		{
			...
			$type = array('alpha'     => esc_attr__( 'Alphabetical', 'templatic-admin' ),'daily'     => esc_attr__( 'Daily', 'templatic-admin' ),'monthly'   => esc_attr__( 'Monthly', 'templatic-admin' ),'postbypost'=> esc_attr__( 'Post By Post', 'templatic-admin' ),'weekly'    => esc_attr__( 'Weekly','templatic-admin' ),'yearly'    => esc_attr__( 'Yearly', 'templatic-admin' ) );
			/* Create an array of archive formats. */
			$format = array('custom'=> esc_attr__( 'Custom', 'templatic-admin' ),'html'  => esc_attr__( 'HTML', 'templatic-admin' ),'option'=> esc_attr__( 'Option', 'templatic-admin' ) );
			?>
			<p>
				<label for="<?php echo $this->get_field_id( 'title' ); ?>">
				<?php echo __( 'Title', 'templatic-admin' ); ?>: 
			...
			<?php echo __( 'Show post count?','templatic-admin'); ?>
...
class templatic_text extends WP_Widget
{
	...
	{
		//Constructor
		$widget_ops = array('classname'    => 'templatic_text','description'  => __('Arbitrary text or HTML','templatic-admin'),'before_widget'=>'<div class="column_wrap">' );
		parent::__construct('templatic_text', __('Text','templatic-admin'), $widget_ops);
	}
	function widget($args, $instance)
	{
		// prints the widget		
	...
	class supreme_authors_widget extends WP_Widget
	{
		...
		*/
		function __construct()
		{
			...
			$widget_options = array(
				'classname'  => 'authors',
				'description'=> esc_html(__( 'An advanced widget that gives you total control over the output of your author lists.', 'templatic-admin' ))
			);
			/* Set up the widget control options. */
			$control_options = array(
				'height'=> 350
			...
			parent::__construct(
				...
				__( 'Authors', 'templatic-admin' ),	// $this->name
				$widget_options,			// $this->widget_options
				$control_options			// $this->control_options
			);
		}
		...
		*/
		function form( $instance )
		{
			...
			/* Merge the user-selected arguments with the defaults. */
			$instance = wp_parse_args( (array) $instance, $defaults );
			$order = array('ASC' => esc_attr__( 'Ascending', 'templatic-admin' ),'DESC'=> esc_attr__( 'Descending', 'templatic-admin' ) );
			$orderby = array('display_name'=> esc_attr__( 'Display Name', 'templatic-admin' ),'email'       => esc_attr__( 'Email', 'templatic-admin' ),'ID'          => esc_attr__( 'ID', 'templatic-admin' ),'nicename'    => esc_attr__( 'Nice Name', 'templatic-admin' ),'post_count'  => esc_attr__( 'Post Count', 'templatic-admin' ),'registered'  => esc_attr__( 'Registered', 'templatic-admin' ),'url'         => esc_attr__( 'URL', 'templatic-admin' ),'user_login'  => esc_attr__( 'Login', 'templatic-admin' ) );
			?>
			<div class="hybrid-widget-controls columns-2">
			  ...
			  <p>
				...
				<select class="widefat" id="<?php echo $this->get_field_id( 'style' ); ?>" name="<?php echo $this->get_field_name( 'style' ); ?>">
				  <?php
					foreach( array( 'list' => esc_attr__( 'List', 'templatic-admin'), 'none' => esc_attr__( 'None', 'templatic-admin' ) ) as $option_value => $option_label )
					{
						?>
			...
			<div class="hybrid-widget-controls columns-2 column-last">
			  ...
			  <p>
				<label for="<?php echo $this->get_field_id( 'html' ); ?>">
				  ...
				  <?php echo '<acronym title="Hypertext Markup Language">'.__('HTML','templatic-admin').'</acronym>?'; ?>
			  ...
			  <p>
				<label for="<?php echo $this->get_field_id( 'exclude_admin' ); ?>">
				  ...
				  <?php echo __( 'Exclude admin?', 'templatic-admin' ); ?>
			  ...
			  <p>
				<label for="<?php echo $this->get_field_id( 'show_fullname' ); ?>">
				  ...
				  <?php echo __( 'Show full name?', 'templatic-admin' ); ?>
			  ...
			  <p>
				<label for="<?php echo $this->get_field_id( 'hide_empty' ); ?>">
				  ...
				  <?php echo __( 'Hide empty?', 'templatic-admin' ); ?>
	...
	class supreme_bookmarks_widget extends WP_Widget
	{
		...
		*/
		function __construct()
		{
			...
			$widget_options = array(
				'classname'  => 'bookmarks',
				'description'=> esc_html(__( 'An advanced widget that gives you total control over the output of your bookmarks (links).', 'templatic-admin' ))
			);
			/* Set up the widget control options. */
			$control_options = array(
				'height'=> 350
			...
			parent::__construct(
				...
				__( 'Bookmarks', 'templatic-admin' ),	// $this->name
				$widget_options,			// $this->widget_options
				$control_options			// $this->control_options
			);
		}
		...
		* Outputs the widget based on the arguments input through the widget controls.*/
		function widget( $sidebar, $instance )
		{
			...
			$args['title_li'] = apply_filters( 'widget_title', ( empty( $args['title_li'] ) ? __( 'Bookmarks', 'templatic' ) : $args['title_li'] ), $instance, $this->id_base );
		...
		*/
		function form( $instance )
		{
			...
			$category_order = array('ASC' => esc_attr__( 'Ascending', 'templatic' ),'DESC'=> esc_attr__( 'Descending', 'templatic' ) );
			$category_orderby = array('count'=> esc_attr__( 'Count', 'templatic' ),'ID'   => esc_attr__( 'ID', 'templatic' ),'name' => esc_attr__( 'Name', 'templatic' ),'slug' => esc_attr__( 'Slug', 'templatic' ) );
			$order = array('ASC' => esc_attr__( 'Ascending', 'templatic' ),'DESC'=> esc_attr__( 'Descending', 'templatic' ) );
			$orderby = array('id'         => esc_attr__( 'ID', 'templatic' ),'description'=> esc_attr__( 'Description',  'templatic' ),'length'     => esc_attr__( 'Length',  'templatic' ),'name'       => esc_attr__( 'Name',  'templatic' ),'notes'      => esc_attr__( 'Notes',  'templatic' ),'owner'      => esc_attr__( 'Owner',  'templatic' ),'rand'       => esc_attr__( 'Random',  'templatic' ),'rating'     => esc_attr__( 'Rating',  'templatic' ),'rel'        => esc_attr__( 'Rel',  'templatic' ),'rss'        => esc_attr__( 'RSS',  'templatic' ),'target'     => esc_attr__( 'Target',  'templatic' ),'updated'    => esc_attr__( 'Updated',  'templatic' ),'url'        => esc_attr__( 'URL',  'templatic' ) );
			?>
		...
		<div class="hybrid-widget-controls columns-3 column-last">
		  ...
		  <p>
			<label for="<?php echo $this->get_field_id( 'categorize' ); ?>">
			  ...
			  <?php echo __( 'Categorize?', 'templatic' ); ?>
		  ...
		  <p>
			<label for="<?php echo $this->get_field_id( 'show_description' ); ?>">
			  ...
			  <?php echo __( 'Show description?', 'templatic' ); ?>
		  ...
		  <p>
			<label for="<?php echo $this->get_field_id( 'hide_invisible' ); ?>">
			  ...
			  <?php echo __( 'Hide invisible?', 'templatic' ); ?>
		  ...
		  <p>
			<label for="<?php echo $this->get_field_id( 'show_rating' ); ?>">
			  ...
			  <?php echo __( 'Show rating?', 'templatic' ); ?>
		  ...
		  <p>
			<label for="<?php echo $this->get_field_id( 'show_updated' ); ?>">
			  ...
			  <?php echo __( 'Show updated?', 'templatic' ); ?>
		  ...
		  <p>
			<label for="<?php echo $this->get_field_id( 'show_images' ); ?>">
			  ...
			  <?php echo __( 'Show images?', 'templatic' ); ?>
		  ...
		  <p>
			<label for="<?php echo $this->get_field_id( 'show_name' ); ?>">
			  ...
			  <?php echo __( 'Show name?', 'templatic' ); ?>
		  ...
		  <p>
			<label for="<?php echo $this->get_field_id( 'show_private' ); ?>">
			  ...
			  <?php echo __( 'Show private?', 'templatic' ); ?>
	...
	class supreme_calendar_widget extends WP_Widget
	{
		...
		*/
		function __construct()
		{
			...
			$widget_options = array(
				'classname'  => 'calendar',
				'description'=> esc_html(__( 'An advanced widget that gives you total control over the output of your calendar.', 'templatic-admin' ))
			);
			/* Set up the widget control options. */
			$control_options = array(
				'height'=> 350
			...
			parent::__construct(
				...
				__( 'Calendar', 'templatic-admin' ),	// $this->name
				$widget_options,			// $this->widget_options
				$control_options			// $this->control_options
			);
		}
		...
		<div class="hybrid-widget-controls columns-1">
		  ...
		  <p>
			...
			<label for="<?php echo $this->get_field_id( 'initial' ); ?>">
			  <?php echo __( 'One-letter abbreviation?', 'templatic' ); ?>
			  <code>
			  <?php echo __('initial','templatic'); ?>
			  </code> </label>
		  </p>
		</div>
<?php
		...
		*/
		function __construct()
		{
			...
			$widget_options = array(
				...
				'description'=> esc_html(__( 'An advanced widget that gives you total control over the output of your category links.', 'templatic-admin' ))
			);
			/* Set up the widget control options. */
			$control_options = array(
				'height'=> 350
			...
			parent::__construct(
				...
				__( 'Categories', 'templatic-admin' ),	// $this->name
				$widget_options,			// $this->widget_options
				$control_options			// $this->control_options
			);
		}
	...
	*/
	function widget( $sidebar, $instance )
	{
		...
		if ( $d ) {
			...
			$dropdown_args['show_option_none'] = __('Select Category','templatic');
			...
			jQuery(document).ready(function(){
				jQuery('#<?php echo $tmpl_rand_id; ?> option').each(function(){
				...
				jQuery(document).on('change','#<?php echo $tmpl_rand_id; ?>', function(){
		...
		*/
		function form( $instance )
		{
			...
			$style = array('list'=> esc_attr__( 'List', 'templatic-admin' ),'none'=> esc_attr__( 'None', 'templatic-admin' ) );
			$order = array('ASC' => esc_attr__( 'Ascending', 'templatic-admin' ),'DESC'=> esc_attr__( 'Descending', 'templatic-admin' ) );
			$orderby = array('count'     => esc_attr__( 'Count', 'templatic-admin' ),'ID'        => esc_attr__( 'ID', 'templatic-admin' ),'name'      => esc_attr__( 'Name', 'templatic-admin' ),'slug'      => esc_attr__( 'Slug', 'templatic-admin' ),'term_group'=> esc_attr__( 'Term Group', 'templatic-admin' ) );
			$feed_type = array(''    => '','atom'=> esc_attr__( 'Atom', 'templatic-admin' ),'rdf' => esc_attr__( 'RDF', 'templatic-admin' ),'rss' => esc_attr__( 'RSS', 'templatic-admin' ),'rss2'=> esc_attr__( 'RSS 2.0', 'templatic-admin' ) );
			...
			<?php echo __('(Applicable only when Hierarchical is enabled)','templatic-admin');?>
			</p>
			<p class="cat_opt" <?php echo $shoblock; ?>>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"> <code> number </code> </label>
			<input type="text" class="smallfat code" id="<?php echo $this->get_field_id( 'number' ); ?>" name="<?php echo $this->get_field_name( 'number' ); ?>" value="<?php echo esc_attr( $instance['number'] ); ?>" />
			...
			<label for="<?php echo $this->get_field_id( 'hierarchical' ); ?>">
			  ...
			  <?php echo __( 'Hierarchical?', 'templatic-admin' ); ?>
			...
			<label for="<?php echo $this->get_field_id( 'use_desc_for_title' ); ?>">
			  ...
			  <?php echo __( 'Use description?', 'templatic-admin' ); ?>
			...
			<label for="<?php echo $this->get_field_id( 'show_count' ); ?>">
			  ...
			  <?php echo __( 'Show count?', 'templatic-admin' ); ?>
			...
			<label for="<?php echo $this->get_field_id( 'dropdown' ); ?>">
			  ...
			  <?php echo __( 'Display as dropdown', 'templatic-admin' ); ?>
			  <code> display_as_dropdown </code> </label>
			</p>
			<p><strong><?php echo __('Note: ','templatic-admin')?></strong><?php echo __('Use only one Categories widget on the <b>single page</b> if you choose "dropdown" option.');?></p>
			</div>
			<script>
				jQuery(document).ready(function(){
		...
		*/
		function __construct()
		{
			...
			$widget_options = array(
				...
				'description'=> esc_html(__( 'An advanced widget that gives you total control over the output of your menus.', 'templatic-admin' ))
			);
			/* Set up the widget control options. */
			$control_options = array(
				'height'=> 350
			...
			parent::__construct(
				...
				__( 'Navigation Menu', 'templatic-admin' ),	// $this->name
				$widget_options,				// $this->widget_options
				$control_options				// $this->control_options
			);
		}
	...
	class supreme_pages_widget extends WP_Widget
	{
		...
		*/
		function __construct()
		{
			...
			$widget_options = array(
				'classname'  => 'pages',
				'description'=> esc_html(__( 'An advanced widget that gives you total control over the output of your page links.', 'templatic-admin' ))
			);
			/* Set up the widget control options. */
			$control_options = array(
				'height'=> 350
			...
			parent::__construct(
				...
				__( 'Pages', 'templatic-admin'),		// $this->name
				$widget_options,			// $this->widget_options
				$control_options			// $this->control_options
			);
		}
		...
		*/
		function form( $instance )
		{
			...
			$sort_order = array('ASC' => esc_attr__( 'Ascending', 'templatic-admin' ),'DESC'=> esc_attr__( 'Descending', 'templatic-admin' ) );
			$sort_column = array('post_author'  => esc_attr__( 'Author', 'templatic-admin' ),'post_date'    => esc_attr__( 'Date', 'templatic-admin' ),'ID'           => esc_attr__( 'ID', 'templatic-admin' ),'menu_order'   => esc_attr__( 'Menu Order', 'templatic-admin' ),'post_modified'=> esc_attr__( 'Modified', 'templatic-admin' ),'post_name'    => esc_attr__( 'Slug', 'templatic-admin' ),'post_title'   => esc_attr__( 'Title', 'templatic-admin' ) );
			$show_date = array(''        => '','created' => esc_attr__( 'Created', 'templatic-admin' ),'modified'=> esc_attr__( 'Modified', 'templatic-admin' ) );
	...
	class supreme_search_widget extends WP_Widget
	{
		...
		*/
		function __construct()
		{
			...
			$widget_options = array(
				'classname'  => 'search',
				'description'=> esc_html(__( 'An advanced widget that gives you total control over the output of your search form.', 'templatic-admin' ))
			);
			/* Set up the widget control options. */
			/* Create the widget. */
			parent::__construct(
				'hybrid-search',			// $this->id_base
				__( 'Search', 'templatic-admin' ),	// $this->name
				@$widget_options			// $this->widget_options
		...
		<div class="hybrid-widget-controls columns-2">
		  ...
		  <p>
			<label for="<?php echo $this->get_field_id( 'search_label' ); ?>">
			  <?php echo __( 'Search Label:', 'templatic-admin' ); ?>
			</label>
		  ...
		  <p>
			<label for="<?php echo $this->get_field_id( 'search_text' ); ?>">
			  <?php echo __( 'Search Text:', 'templatic-admin' ); ?>
			</label>
		...
		<div class="hybrid-widget-controls columns-2 column-last">
		  <p>
			<label for="<?php echo $this->get_field_id( 'search_submit' ); ?>">
			  <?php echo __( 'Search Submit:', 'templatic-admin' ); ?>
			</label>
		  ...
		  <p>
			<label for="<?php echo $this->get_field_id( 'theme_search' ); ?>">
			  ...
			  <?php echo __( 'Use theme\'s <code>searchform.php</code>?', 'templatic-admin' ); ?>
			</label>
		  </p>
		</div>
		<div style="clear:both;"> &nbsp; </div>
	...
	class supreme_tags_widget extends WP_Widget
	{
		...
		*/
		function __construct()
		{
			...
			$widget_options = array(
				'classname'  => 'tags',
				'description'=>  __( 'An advanced widget that gives you total control over the output of your tags.' ,'templatic-admin')
			);
			/* Set up the widget control options. */
			$control_options = array(
				'height'=> 350
			...
			parent::__construct(
				...
				__( 'Tags' , 'templatic-admin' ),		// $this->name
				$widget_options,			// $this->widget_options
				$control_options			// $this->control_options
			);
		}
		...
		*/
		function form( $instance )
		{
			...
			/* <select> element options. */
			$taxonomies = get_taxonomies( array('show_tagcloud'=> true ), 'objects' );
			$link = array('view'=> esc_attr__( 'View', 'templatic-admin' ),'edit'=> esc_attr__( 'Edit', 'templatic-admin' ) );
			$format = array('flat'=> esc_attr__( 'Flat', 'templatic-admin' ),'list'=> esc_attr__( 'List', 'templatic-admin' ) );
			$order = array('ASC' => esc_attr__( 'Ascending', 'templatic-admin' ),'DESC'=> esc_attr__( 'Descending', 'templatic-admin' ),'RAND'=> esc_attr__( 'Random', 'templatic-admin' ) );
			$orderby = array('count'=> esc_attr__( 'Count', 'templatic-admin' ),'name' => esc_attr__( 'Name', 'templatic-admin' ) );
			...
			<div class="hybrid-widget-controls columns-3 column-last">
				...
				<label for="<?php echo $this->get_field_id( 'pad_counts' ); ?>">
				  ...
				  <?php echo __( 'Pad counts?', 'templatic-admin' ); ?>
	...
	class supreme_google_map extends WP_Widget
	{
		function __construct()
		{
			...
			parent::__construct(
				...
				__( 'T &rarr; Google Map Location', 'templatic-admin' ),	// $this->name
				$widget_options,			// $this->widget_options
				$control_options			// $this->control_options
			);
		}
		function widget($args, $instance)
		{
			...
			*/
			...
			?>
			<script type="text/javascript" src="<?php echo $http; ?>maps.google.com/maps/api/js?sensor=false<?php echo $lang.$key; ?>"></script>
			...
			{
				alert("<?php _e("Geocode was not successful for the following reason",'templatic'); ?>: " + status);
			}
			});
			}
		...
		{
			//widgetform in backend
			$instance = wp_parse_args( (array) $instance, array('title'=> __("Find us on map",'templatic')) );
			$title   = ($instance['title']);
		...
		<p>
		  <label for="<?php echo $this->get_field_id('address'); ?>">
			<?php  echo __('Address: <small>(eg: 230 Vine Street And locations throughout Old City, Philadelphia, PA 19106)</small>','templatic-admin');?>
		...
		<p>
		  <label for="<?php echo $this->get_field_id('map_height'); ?>">
			<?php  echo __('Map Height in pixels: <small>(To change, only enter a numeric value)</small>','templatic-admin');?>
		...
		<p>
		  <label for="<?php echo $this->get_field_id('scale'); ?>">
			<?php  echo __('Map Zoom Factor','templatic-admin');?>
			:
		...
		<p>
		  <label for="<?php echo $this->get_field_id('map_type'); ?>">
			<?php  echo __('Select Map Type','templatic-admin');?>
			:
		...
		{echo 'selected="selected"';}?> >
			  <?php  echo __('Road Map','templatic-admin');?>
			  </option>
			  <option value="SATELLITE" <?php
		 if(esc_attr($map_type) == 'SATELLITE')
		{echo 'selected="selected"';}?>>
			  <?php  echo __('Satellite Map','templatic-admin');?>
			  </option>
			</select>
		  </label>
		</p>
...
if(!class_exists('supreme_social_media'))
{
	class supreme_social_media extends WP_Widget
	{
		...
		{
			//Constructor
			$widget_ops = array('classname'  => 'social_media','description'=> apply_filters('supreme_social_media_description',__('Add icons and links to your social media accounts. Works in header, footer, main content and sidebar widget areas.','templatic-admin')) );
			parent::__construct('social_media', __('T &rarr; Social Media','templatic-admin'), $widget_ops);
		}
		function widget($args, $instance)
		{
			// prints the widget
			...
			<div class="social_media">
			  <ul class="social_media_list">
				...
				<li> <a href="<?php echo @$social_link[$c]; ?>" target="_blank" >
				  <?php
											if( @$social_icon[$c] != ''):?>
				  <span class="social_icon"> <img src="<?php echo @$social_icon[$c];?>" alt="<?php echo sprintf(__('%s','templatic'), @$social_text[$c]);?>" /> </span>
				  <?php endif;?>
				  <?php echo (isset($social_text[$c]))? sprintf(__('%s','templatic'), @$social_text[$c]):'';?> </a> </li>
				<?php
								}
								?>
			  </ul>
		...
		{
			//widgetform in backend
			$instance = wp_parse_args((array) $instance, array('title' => __('Connect To Us','templatic-admin'),'social_description'=> __('Find Us On Social Sites','templatic-admin'),'social_link'=> '','social_text'=>''));
		...
		<p> <i> <?php echo __('Please enter full URL to your profiles.','templatic-admin'); ?> </i> </p>
		<p>
		  <label for="<?php echo $this->get_field_id('social_link'); ?>">
			<?php echo __('Social Link','templatic-admin');?>
			:
		...
		<p>
		  <label for="<?php echo $this->get_field_id('social_icon'); ?>">
			<?php echo __('Social Icon','templatic-admin');?>
			:
		...
		<p>
		  <label for="<?php echo $this->get_field_id('social_text1'); ?>">
			<?php echo __('Social Text','templatic-admin');?>
			:
		...
		for($i = 1;$i < count($social_link1);$i++)
		{
			if($social_link1[$i] != "")
			{
				...
				echo '<p>';
				echo '<label>'.__('Social Link','templatic-admin').' '.$j;
		...
		<a
				href="javascript:void(0);" id="addtButton" class="addButton" onclick="social_add_tfields('<?php echo $text_social_link; ?>','<?php echo $text_social_icon; ?>','<?php echo $text_social_text; ?>');"> + <?php _e('Add more','templatic');?> </a> &nbsp; | &nbsp; 
		<a
				href="javascript:void(0);" id="removetButton" class="removeButton" onclick="social_remove_tfields();">- <?php _e('Remove','templatic');?> </a>
	<?php
		}
	}
	...
	if(!function_exists('supreme_add_script_addnew_1'))
	{
		...
		function social_add_tfields(name,ilname,sname)
		{
			...
			SocialTextDiv.html('<p><label><?php echo __('Social Link','templatic-admin'); ?> '+ social_counter+': </label>'+'<input type="text" class="widefat" name="'+name+'[]" id="textbox' + social_counter + '" value="" /></p>');
			SocialTextDiv.append('<p><label><?php echo __('Social Icon','templatic-admin'); ?> '+ social_counter+': </label>'+'<input type="text" class="widefat" name="'+ilname+'[]" id="textbox' + social_counter + '" value="" ></p>');
			SocialTextDiv.append('<p><label><?php echo __('Social Text','templatic-admin'); ?> '+ social_counter+': </label>'+'<input type="text" class="widefat" name="'+sname+'[]" id="textbox' + social_counter + '" value="" ></p>');
		...
		function social_remove_tfields()
		{
			...
			{
				alert("<?php echo __('You need one textbox required.','templatic-admin')?>");
				return false;
			}
			social_counter--;
...
if(!class_exists('supreme_subscriber_widget'))
{
	class supreme_subscriber_widget extends WP_Widget
	{
		...
		{
			//Constructor
			$widget_ops = array('classname'  => 'subscribe','description'=> apply_filters('supreme_subscriber_widget_title',__('Shows a subscribe box with which users can subscribe to your newsletter. Works best in main content, subsidiary and footer areas.','templatic-admin') ));
			parent::__construct('supreme_subscriber_widget',apply_filters('subscribewidget_filter',__('T &rarr; Newsletter','templatic-admin')), $widget_ops);
		}
		function widget($args, $instance)
		{
			// prints the widget
		...
		if($newsletter_provider == 'feedburner')
		{
			...
			<div class="subscriber_container">
				<form action="//feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open('//feedburner.google.com/fb/a/mailverify?uri=<?php echo $feedburner_id; ?>', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true" >
		...
		{	
			...
			?>
		  <div class="subscriber_container">
			<input type="text" name="name" id="name" value="" placeholder="<?php _e('Name','templatic');?>" class="field" onfocus="if (this.placeholder == 'Name') {this.placeholder = '';}" onblur="if (this.placeholder == '') {this.placeholder = '<?php _e('Name','templatic');?>';}"  />
			...
			<input class="replace" type="submit" name="mailchimp_submit" id="mailchimp_submit" value="<?php _e('Subscribe','templatic');?>" />
		...
		<form Method="POST" action="http://www.feedblitz.com/f/f.fbz?AddNewUserDirect" target="popupwindow" onsubmit="window.open('http://www.feedblitz.com/f/f.fbz?AddNewUserDirect', 'popupwindow', 'scrollbars=yes,width=600,height=730');return true" >
			...
			<input type="submit" name="feedblitz_submit" value="<?php _e("Subscribe",'templatic');?>">
			<br />
		</form>
		</div>
		<?php
		...
		<form method="post" action="http://www.aweber.com/scripts/addlead.pl">
			...
			<input type="text" name="name" id="name" value="" class="field" onfocus="if (this.placeholder == '<?php _e('Name','templatic'); ?>') {this.placeholder = '';}" onblur="if (this.placeholder == '') {this.placeholder = '<?php _e('Names','templatic'); ?>';}" placeholder="<?php _e('Names','templatic'); ?>"/>
			<input type="text" name="email" id="email" value="" class="field" onfocus="if (this.placeholder == '<?php _e('Your Email Address','templatic'); ?>') {this.placeholder = '';}" onblur="if (this.placeholder == '') {this.placeholder = '<?php _e('Your Email Address','templatic'); ?>';}" placeholder="<?php _e('Your Email Address','templatic'); ?>"/>
		...
		{
			//widgetform in backend
			$instance = wp_parse_args( (array) $instance, array('title' => __("Subscribe To Newsletter",'templatic-admin'),'text' => __("Subscribe to get our latest news",'templatic-admin'),'newsletter_provider'=> 'feedburner','feedburner_id'      => '','mailchimp_api_key'  => '','mailchimp_list_id'  => '','aweber_list_name'   => '','feedblitz_list_id'  => '') );
		...
		<p>
		  <label for="<?php echo $this->get_field_id('text'); ?>">
			<?php echo __('Text Below Title:','templatic-admin');?>
			<input class="widefat" id="<?php echo $this->get_field_id('text'); ?>" name="<?php echo $this->get_field_name('text'); ?>" type="text" value="<?php echo esc_attr($text); ?>" />
		  </label>
		</p>
		<p>
		  <label for="<?php echo $this->get_field_id('newsletter_provider'); ?>">
			<?php echo __("Newsletter Provider",'templatic-admin');?>
			:
		...
		{echo 'display:none';};?>">
		  <label for="<?php echo $this->get_field_id('feedburner_id'); ?>">
			<?php echo __('ID:','templatic-admin');?>
		...
		{echo 'display:none';};?>">
		  <label for="<?php echo $this->get_field_id('mailchimp_api_key'); ?>">
			<?php echo __('Mailchimp API Key:','templatic-admin');?>
		  ...
		  <label for="<?php echo $this->get_field_id('mailchimp_list_id'); ?>">
			<?php echo __('List Id:','templatic-admin');?>
		...
		{echo 'display:none';};?>">
		  <label for="<?php echo $this->get_field_id('aweber_list_name'); ?>">
			<?php echo __('Unique List Id:','templatic-admin');?>
	...
	if(!function_exists('attach_mailchimp_js'))
	{
		...
		<script type="text/javascript">
			...
			jQuery('#mailchimp_submit').click(function()
			{
				...
				var datastring = '&name=' + escape(jQuery('.subscriber_container #name').val()) + '&email=' + escape(jQuery('.subscriber_container #email').val()) + '&api_key=<?php echo $mailchimp_api_key;?>&list_id=<?php echo $mailchimp_list_id;?>';
				jQuery.ajax(
					{
...
if(!class_exists('supreme_testimonials_widget'))
{
	class supreme_testimonials_widget extends WP_Widget
	{
		function supreme_testimonials_widget()
		{
			...
			parent::__construct('testimonials_widget',apply_filters('templ_testimonial_widget_title_filter',__('T &rarr; Testimonials','templatic-admin')), $widget_ops);
		}
		function widget($args, $instance)
		{
			// prints the widget
		...
		if($link_url != "" && $link_text != "")
		{
			...
			{
				$link_text = sprintf(__('%s','templatic'),$link_text);
			}
			?>
		...
		<?php echo __('Quote text','templatic-admin');?>
		:
		...
		<?php echo __("Link Text",'templatic-admin');?>
		:
		...
		<?php echo __("Link Url",'templatic-admin');?>
		:
...
{
	?>
	<a	href="javascript:void(0);" id="addtButton" class="addButton" type="button" onclick="add_tfields('<?php echo $text_author; ?>','<?php echo $text_quotetext; ?>');">+ <?php _e('Add More','templatic-admin');?></a>
<?php
}
/*-----------------------------------------------
	...
	class supreme_banner_slider extends WP_Widget
	{
		function __construct()
		{
			parent::__construct(
				...
				__('T &rarr; Homepage Banner','templatic-admin'), // Name
				array('description'=> apply_filters('tmpl_banner_widget_description',__('Display images from a specific category or a collection of static images. The widget works best in the Homepage Banner area.','templatic-admin')))
			);
		}
			...
			*/
			...
			global $post,$wpdb;
				...
				if($post_type !='post'){
					...
					if(is_plugin_active('Tevolution-LocationManager/location-manager.php') && strpos($location_post_type,$post_type.',') !== false)
					{
				...
				$no_bannerclass = ($custom_banner_temp != 1 && $banner_number == 0)? 'no_bannerclass':'';
				
				/* do not show navigation arrow if only one image is there */
				$show_nav = (($custom_banner_temp != 1 && $banner_number <= 1) || count($s1) <= 1) ? 'false' : 'true';
			...
			jQuery('.<?php echo $class;?>').flexslider(
				{
					...
					directionNav: <?php echo $show_nav; ?>,
						
					prevText: '<?php echo apply_filters('tmpl_homepage_slider_left_aerrow','<i class="fa fa-chevron-left"></i>'); ?>',
					nextText: '<?php echo apply_filters('tmpl_homepage_slider_right_aerrow','<i class="fa fa-chevron-right"></i>');?>',
			...
			<ul class="slides<?php if($no_bannerclass){echo ' '.$no_bannerclass; }?>">
			<?php
			if(isset($instance['custom_banner_temp']) && $instance['custom_banner_temp'] == 1):
				...
				if($s1[$i] != ""): ?>
				<li class="post_img" >
					<?php if( $s1_title_link[$i] !=''){?><a href="<?php echo $s1_title_link[$i]; ?>" target="_blank"><?php } ?>
					<img height="<?php if(!$is_Carousel){echo $height;} ?>" width="<?php echo $width?>" src="<?php echo $s1[$i]; ?>" alt="<?php echo $s1[$i]; ?>" />
				<?php
				if($s1_title[$i] != ""):?>
					<h2>
					<?php
						...
						<?php
									if(current_theme_supports('slider_thumb_image'))
									{
										if(get_post_meta($post->ID,'featured_h',true) == 'h'){
											...
											<?php echo __('Featured','templatic'); ?>
											</span>
						<?php				}
									}
									?>
		...
		function form($instance)
		{
			...
			//widgetform in backend
			$instance = wp_parse_args( (array) $instance, array('search'            =>'','search_post_type'  =>'','location'          =>'','distance'          =>'','radius'            =>'','post_type'         => '','number'            => '','animation'         =>'fade','slideshowSpeed'    =>'4700','animation_speed'   =>'800','sliding_direction' =>'','reverse'           =>'true','item_width'        =>'','is_Carousel_temp'  =>'','min_item'          =>'','max_items'         =>'','item_move'         =>'','custom_banner_temp'=>'','s1'                => array(get_template_directory_uri().'/images/slide1.jpg',get_template_directory_uri().'/images/slide2.jpg',get_template_directory_uri().'/images/slide1.jpg',get_template_directory_uri().'/images/slide2.jpg'),'s1_title'          => array(__("Slider Title 1",'templatic-admin'), __("Slider Title 2",'templatic-admin'), __("Slider Title 3",'templatic-admin'), __("Slider Title 4",'templatic-admin')),'s1_title_link' => array('#','#','#','#'),'postperslide'      =>'','content_len'       =>'' ,'autoplay'       =>'true' ) );
			...
			<p>
			  <label for="<?php echo $this->get_field_id('title'); ?>">
				<?php echo __('Slider Title','templatic-admin'); ?>
				:
				<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
			  </label>
			</p>
			<p>
			  <label for="<?php echo $this->get_field_id('sdesc'); ?>">
				<?php echo __('Slider Description','templatic-admin'); ?>
				:
			...
			<p>
			  <label for="<?php echo $this->get_field_id('animation'); ?>">
				<?php echo __('Animation','templatic-admin'); ?>
				:
			...
			{?> selected="selected"<?php }?> value="slide">
				  <?php echo __("Slide",'templatic-admin');?>
				  </option>
				</select>
			  </label>
			</p>
			<p>
			  <label for="<?php echo $this->get_field_id('autoplay'); ?>">
				<?php echo __('Slide show','templatic-admin'); ?>
				:
			...
			{?> selected="selected"<?php }?> value="true">
				  <?php echo __("Yes",'templatic-admin');?>
				  </option>
				  <option <?php
			 if(esc_attr($autoplay) == 'false')
			{?> selected="selected"<?php }?> value="false">
				  <?php echo __("No",'templatic-admin');?>
				  </option>
				</select>
			  </label>
			</p>
			<p>
			  <label for="<?php echo $this->get_field_id('sliding_direction'); ?>">
				<?php echo __('Sliding Direction','templatic-admin'); ?>
				:
			...
			{?> selected="selected"<?php }?> value="horizontal">
				  <?php echo __("Horizontal",'templatic-admin');?>
				  </option>
				  <option <?php
			 if(esc_attr($sliding_direction) == 'vertical')
			{?> selected="selected"<?php }?> value="vertical">
				  <?php echo __("Vertical",'templatic-admin');?>
				  </option>
				</select>
			  </label>
			</p>
			<p>
			  <label for="<?php echo $this->get_field_id('reverse'); ?>">
				<?php echo __('Reverse Animation Direction','templatic-admin'); ?>
				:
			...
			{?> selected="selected"<?php }?> value="false">
				  <?php echo __("False",'templatic-admin');?>
				  </option>
				  <option <?php
			 if(esc_attr($reverse) == 'true')
			{?> selected="selected"<?php }?> value="true">
				  <?php echo __("True",'templatic-admin');?>
				  </option>
				</select>
			  </label>
			</p>
			<p>
			  <label for="<?php echo $this->get_field_id('slideshowSpeed'); ?>">
				<?php echo __('Slide Show Speed','templatic-admin'); ?>
				:
			...
			<p>
			  <label for="<?php echo $this->get_field_id('animation_speed'); ?>">
				<?php echo __('Animation Speed','templatic-admin'); ?>
				:
			...
			<p> <br/>
			  <label for="<?php echo $this->get_field_id('is_Carousel'); ?>">
				...
				<?php echo __("<b>Settings for Carousel slider option?</b>",'templatic-admin');?>
			  </label>
			</p>
			<div id="<?php echo $this->get_field_id('home_slide_carousel'); ?>" style="<?php if($is_Carousel == '1'){ ?>display:block;<?php }else{?>display:none;<?php }?>">
			  <p>
				<label for="<?php echo $this->get_field_id('item_width'); ?>">
				  <?php echo __('Item Width <br/><small>(Box-model width of individual items, including horizontal borders and padding.)</small>','templatic-admin'); ?>
			  ...
			  <p>
				<label for="<?php echo $this->get_field_id('min_item'); ?>">
				  <?php echo __('Min Item <br/><small>(Minimum number of items that should be visible. Items will resize fluidly when below this.)</small>','templatic-admin'); ?>
			  ...
			  <p>
				<label for="<?php echo $this->get_field_id('max_items'); ?>">
				  <?php echo __('Max Item <br/><small>(Maximum number of items that should be visible. Items will resize fluidly when above this limit.)</small>','templatic-admin'); ?>
			  ...
			  <p>
				<label for="<?php echo $this->get_field_id('item_move'); ?>">
				  <?php echo __('Items Move <br/><small>(Number of items that should move on animation. If 0, slider will move all visible items.)</small>','templatic-admin'); ?>
			  ...
			  <p>
				<label for="<?php echo $this->get_field_id('postperslide'); ?>">
				  <?php echo __('Posts Per Slide <br/><small>Number of items you want to show in one slide. this option is work with LI tag, it will show all images in one LI tag. </small>','templatic-admin'); ?>
			...
			<label for="<?php echo $this->get_field_id('content'); ?>">
			  ...
			  <b>
			  <?php echo __('Enable Post Excerpt In Slider','templatic-admin');?>
			  </b> </label>
			</p>
			<?php
			} 
			...
			{?>display:block;<?php }?>">
			  <p>
				<label for="<?php echo $this->get_field_id('post_type');?>" >
				  <?php echo __('Select Category','templatic-admin');?>
				...
				<small>
				<?php echo __('Select the categories you want to display inside the slider. All categories must be from a single post type.','templatic-admin');?>
				</small> </p>
			<p>
			<label for="<?php echo $this->get_field_id('number'); ?>">
			  <?php echo __('Number of posts:','templatic-admin');?>
			  <input class="widefat" id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo esc_attr($number); ?>" />
			</label>
			</p>
			<p>
			<label for="<?php echo $this->get_field_id('content_len'); ?>">
			  <?php echo __('Excerpt Length:','templatic-admin');?>
			...
			&nbsp;
			<?php echo __('<b>Use Custom Images?</b>','templatic-admin');?>
			<br/>
			</label>
			<br/>
			</p>
			...
			{?>display:none;<?php }?>">
				...
				<div id="TextBoxDiv1" class="TextBoxDiv1">
				  ...
				  <p>
					...
					<label for="<?php echo $this->get_field_id('s1_title'); ?>">
					  <?php echo __('Banner Slider Title 1','templatic-admin');?>
				  ...
				  <p>
					...
					<label for="<?php echo $this->get_field_id('s1_title_link'); ?>">
					  <?php echo __('Banner Slider Title Link 1','templatic-admin');?>
				  ...
				  <p>
					...
					<label for="<?php echo $this->get_field_id('s1'); ?>">
					  <?php echo __('Banner Slider Image 1 full URL <small>(ex.http://templatic.com/images/banner1.png )</small>  :','templatic-admin');?>
			  ...
			  <a href="javascript:void(0);" id="addButton" class="addButton" onclick="add_textbox('<?php echo $textbox_name;?>','<?php echo $textbox_title_link; ?>','<?php echo $textbox_title;?>');"> <?php echo __('+Add more','templatic-admin'); ?> </a> &nbsp; | &nbsp; 
			  <a	href="javascript:void(0);" id="removeButton" class="removeButton" onclick="remove_textbox();"><?php echo __('-Remove','templatic-admin'); ?> </a>
			</div>
			<?php
		}
	}
	...
	function supreme_multitext_box()
	{
		...
		<script type="application/javascript">
			...
			function remove_textbox()
			{
				...
				{
					alert("<?php echo __('One textbox required.','templatic-admin'); ?>");
					return false;
				}
				banner_counter--;
...
if(!class_exists('supreme_contact_widget'))
{
	class supreme_contact_widget extends WP_Widget
	{
		...
		{
			//Constructor
			$widget_ops = array('classname'  => 'contact_us','description'=> apply_filters('templ_contact_widget_desc_filter',__('A simple contact form visitors can use to get in touch with you. Works best in sidebar areas.','templatic-admin')) );
			parent::__construct('supreme_contact_widget', apply_filters('templ_contact_widget_title_filter',__('T &rarr; Contact Us','templatic-admin')), $widget_ops);
		}
		function widget($args, $instance)
		{
					...
					function widget_send_contact_email($data){
					    ...
					    $tmpdata = get_option('templatic_settings');
						 if ($tmpdata['contact_us_email_content'] != "") {
							...
							$message .= '<p>'.__("Dear",'templatic').' '.$toEmailName.',</p>';
							$message .= '<p>'.__("You have an inquiry message. Here are the details",'templatic').',</p>';
							$message .= '<p>'.__("Name",'templatic').': '.$data['your-name'].'</p>';
							$message .= '<p>'.__("Email",'templatic').': '.$data['your-email'].'</p>';
							$message .= '<p>'.__("Message",'templatic').': '.nl2br($data['your-message']).'</p>';
						...
						templ_send_email($data['your-email'],$data['your-name'],$toEmail,$toEmailName,$subject,$message);
			...
			function validate_widget_recaptcha()
			{
				if($cwidget("#recaptcha_response_field").val() == '')
				{
					...
					recaptcha_response_fieldInfo.text(" <?php _e("Please enter captcha",'templatic'); ?> ");
			...
			if(isset($_REQUEST['capt']) && $_REQUEST['capt'] == 'captch' && !isset($_REQUEST['message'])){
				?>
				  <p class="error_msg">
					<?php _e('Please fill the captcha form.','templatic');?>
				  </p>
			<?php } 
			if(isset($_REQUEST['invalid']) == 'playthru') {
				echo '<div class="error_msg">'; _e('You need to play the game to contact us.','templatic'); echo '</div>';
			}
			if(isset($_REQUEST['message']) && $_REQUEST['message'] == 'success'){ ?>
				<p class="success_msg"> <?php _e('Thank you! Your message has been successfully sent.','templatic'); ?> </p>
			<?php
			}elseif(isset($_REQUEST['err']) && $_REQUEST['err'] == 'empty'){	?>
				<p class="error_msg"> <?php _e('Please fill out all the fields before submitting.','templatic');?> </p>
			<?php }	?>
			<form action="<?php echo $_SERVER['REQUEST_URI'];?>" method="post" id="contact_widget_frm" name="contact_frm" class="wpcf7-form">
				...
				<div class="form_row ">
				  <input type="text" name="your-name" id="widget_your-name" value="" class="textfield" size="40" placeholder="<?php _e('Name','templatic');?>*" />
				  <span id="widget_your_name_Info" class="error"></span> </div>
				<div class="form_row ">
				  <input type="text" name="your-email" id="widget_your-email" value="" class="textfield" size="40" placeholder="<?php _e('Email','templatic');?>*"/>
				  <span id="widget_your_emailInfo"  class="error"></span> </div>
				<div class="form_row ">
				  <input type="text" name="your-subject" id="widget_your-subject" value="" size="40" class="textfield" placeholder="<?php _e('Subject','templatic');?>*"/>
				...
				<div class="form_row clearfix">
				  <textarea name="your-message" id="widget_your-message" cols="40" class="textarea textarea2" rows="10" placeholder="<?php _e('Message','templatic');?>"></textarea>
				  ...
				  <?php 
					if($captcha == 1)
					{
						...
						if(empty($display) && (!in_array('registration', $display) && !in_array('submit', $display) && !in_array('claim', $display) && !in_array('emaitofrd', $display) && !in_array('sendinquiry', $display))){
							...
							echo '<script src="https://www.google.com/recaptcha/api.js?onload=onloadCallback&amp;render=explicit&hl='.$tmpdata['captcha_language'].'" async ></script>';
						}
					}			
					?>
		...
		function form($instance)
		{
			...
			<p>
			  <label for="<?php echo $this->get_field_id('title'); ?>">
				<?php echo __('Widget Title','templatic-admin');?>
				:
				<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
			  </label>
			</p>
...
if(!class_exists('supreme_recent_post'))
{
	class supreme_recent_post extends WP_Widget
	{
		...
		{
			//Constructor
			$widget_ops = array('classname'  => 'listing_post','description'=> __('Showcase posts from a particular category and post type. Use in main content, subsidiary and sidebar areas.','templatic-admin') );
			parent::__construct('supreme_recent_post', __('T &rarr; Display Posts','templatic-admin'), $widget_ops);
		}
		function widget($recent_post_args, $instance)
		{
			...
			$instance = wp_parse_args( (array)$instance, array(
					...
					'show_title'        => 0,
					'show_byline'       => 0,
					'post_info'         => '[post_date] ' . __('By', 'templatic') . ' [post_author_posts_link] [post_comments]',
					'show_content'      => 'content',
					'content_limit'     => 25,
					'enable_categories' => '',
					'more_text'         => __('[Read More...]', 'templatic'),
				));
			...
			/* else
			{
				...
				echo $cat_id = substr(@$cat_id,0, - 1);echo '---------';
			} */
			...
			if($instance['post_type_taxonomy'] && $instance['post_type'] !='post')
			{	
			...
			else if($instance['post_type_taxonomy'] && $instance['post_type'] =='post')
			{	
				$featured_arg = array('post_type'=> $instance['post_type'],'showposts'=> $instance['post_number'],'orderby'  => $instance['orderby'],'order'    => $instance['order'],'post_status'=>'publish','tax_query' => array(
						array(
							'taxonomy'=>'category',
			...
			else
			{
				...
				$featured_arg = array('post_type'=> $instance['post_type'],'post_status'=>'publish','showposts'=> $instance['post_number'],'orderby'  => $instance['orderby'],'category__in'=> $cats,'order'    => $instance['order']
				);
			...
			<?php
				...
				<?php if(@$featured){echo '<span class="featured_tag">'.__('Featured','templatic').'</span>';}?>
			...
			<p>
			<label for="<?php echo $this->get_field_id('post_type');?>" >
			<?php echo __('Select Post type:','templatic');?>
			...
			<option value="">
			<?php echo __('---Select Category wise recent post ---','templatic-admin'); ?>
			</option>
			<?php
			...
			<?php echo __('Show Author Gravatar', 'templatic-admin'); ?>
			</label>
			</p>
			<p>
			<label for="<?php echo $this->get_field_id('gravatar_size'); ?>">
			<?php echo __('Gravatar Size', 'templatic-admin'); ?>
			: </label>
			...
			<?php echo __('Show Featured Image', 'templatic-admin'); ?>
			</label>
			</p>
			<p>
			<label for="<?php echo $this->get_field_id('image_size'); ?>">
			<?php echo __('Image Size', 'templatic-admin'); ?>
			: </label>
			<?php
			...
			<?php echo __('thumb', 'templatic-admin'); ?>
			...
			<?php echo __('Show Post Title', 'templatic-admin'); ?>
			</label>
			</p>
			<p>
			<label for="<?php echo $this->get_field_id('show_content'); ?>">
			<?php echo __('Content Type', 'templatic-admin'); ?>
			: </label>
			...
			<?php echo __('Limit content to', 'templatic-admin'); ?>
			</label>
			...
			<?php echo __('characters', 'templatic-admin'); ?>
			</p>
			<p>
			<label for="<?php echo $this->get_field_id('more_text'); ?>">
			<?php echo __('More Text (if applicable)', 'templatic-admin'); ?>
			: </label>
...
if(!class_exists('supreme_popular_post'))
{
	class supreme_popular_post extends WP_Widget
	{
		...
		{
			//Constructor
			$widget_ops = array('classname'  => 'widget-twocolumn popular_posts','description'=> __('Show a list of popular posts from a particular post type. Popularity is determined by total/daily views or comments. Works best in sidebar areas.','templatic-admin') );
			parent::__construct('templatic_popular_post_technews', __('T &rarr; Popular Posts','templatic-admin'), $widget_ops);
		}
		function widget($args, $instance)
		{
			extract($args, EXTR_SKIP);
			...
			{	?>
				...
				<li>
				  <?php _e("There is no post available right now.",'templatic');?>
				</li>
				</ul><?php
			}	?>
		...
		<p>
		  <label for="<?php echo $this->get_field_id('post_type');?>" >
			<?php echo __('Select Post type','templatic-admin');?>
			:
			<select id="<?php echo $this->get_field_id('post_type'); ?>" name="<?php echo $this->get_field_name('post_type'); ?>" class="widefat" >
			  <?php
								$all_post_types = get_post_types();
		...
		<p>
		  <label for="<?php  echo $this->get_field_id('number'); ?>">
			<?php echo __('Total Number of Posts','templatic-admin');?>
			:
		...
		<br/>
		<small>
		<?php echo __("You can change Excerpt length from customizer Listing Page Settings",'templatic-admin');?>
		</small> 
		</p>
		<p>
		...
		<p>
		  <label for="<?php  echo $this->get_field_id('slide'); ?>">
			<?php echo __('Number of Posts Per Slide','templatic-admin');?>
			:
		...
		<p>
		  <label for="<?php  echo $this->get_field_id('popular_per'); ?>">
			<?php echo __('Shows post as per view counting/comments','templatic-admin');?>
			:
		...
		{ ?>selected='selected'<?php } ?>>
			  <?php echo __('Total views','templatic-admin'); ?>
			  </option>
			  <option value="dailyviews" <?php
		 if($instance['popular_per'] == 'dailyviews')
		{ ?>selected='selected'<?php } ?>>
			  <?php echo __('Daily views','templatic-admin'); ?>
			  </option>
			  <option value="comments" <?php
		 if($instance['popular_per'] == 'comments')
		{ ?>selected='selected'<?php } ?>>
			  <?php echo __('Total comments','templatic-admin'); ?>
			  </option>
			</select>
		  </label>
		</p>
		...
		{ echo 'display:none'; }?>"> <small>
		  <?php echo __("To make this widget work with daily views/total views, enable view counter from Tevolution - &gt; General Settings - &gt; Detail/Single Page Settings",'templatic-admin');?>
		  </small>
		</p>
		<p>
		  <label for="<?php  echo $this->get_field_id('pagination_position'); ?>">
			<?php echo __('Pagination Position','templatic-admin');?>
			:
		...
		{ ?>selected='selected'<?php } ?>>
			  <?php echo __('After Posts','templatic-admin'); ?>
			  </option>
			  <option value="1" <?php
		 if($instance['pagination_position'] == 1)
		{ ?>selected='selected'<?php } ?>>
			  <?php echo __('Before Posts','templatic-admin'); ?>
			  </option>
			</select>
		  </label>
		</p>
...
---------------------------------------------------------------*/
define('NUMBER_REVIEWS_TEXT',__('Number of Reviews','templatic-admin'));
if(!class_exists('supreme_recent_review'))
{
	class supreme_recent_review extends WP_Widget
	{
		...
		{
			//Constructor
			$widget_ops = array('classname'  => 'widget-twocolumn recent_reviews','description'=> __('Display recent reviews from a specific post type. Works best in sidebar areas.','templatic-admin') );
			parent::__construct('widget_comment', __('T &rarr; Recent Reviews','templatic-admin'), $widget_ops);
		}
		function widget($args, $instance)
		{
			// prints the widget
		...
		<p>
		  <label for="<?php echo $this->get_field_id('post_type');?>" >
			<?php echo __('Select Post:','templatic-admin');?>
			<select  id="<?php echo $this->get_field_id('post_type'); ?>" name="<?php echo $this->get_field_name('post_type'); ?>" class="widefat">
			  <?php
								$all_post_types = get_post_types();
								foreach($all_post_types as $post_types)
	...
	function recent_review_comments($g_size = 30, $no_comments = 10, $comment_lenth = 60, $show_pass_post = false,$post_type = 'post',$title = '')
	{
		...
		if(isset($comments))
		{
			...
			{ 
				...
				echo  '<a href="'.$permalink.'" class="title">'.$comment->comment_author.'</a>';
				$tmpdata = get_option('templatic_settings');
		...
		if(!class_exists('templatic_woo_shopping_cart_info'))
		{
			class templatic_woo_shopping_cart_info extends WP_Widget
			{
				...
				function templatic_woo_shopping_cart_info()
				{
					...
					$this->woo_widget_description = __( "Display Cart Informations with automatic cart update. Best to use it in \"Header right\" sidebar", 'templatic-admin' );
					$this->woo_widget_idbase = 'woocommerce_widget_cart';
					$this->woo_widget_name = __( 'T &rarr; WooCommerce Shopping Cart', 'templatic-admin' );
					//Constructor
					$widget_ops = array('classname'  => 'widget WooCommerce shopping cart info','description'=>  apply_filters('supreme_woo_shop_cart_description',__('Displays Cart Information with automatic cart update. Most suitable widget area for it is "Header right area"','templatic-admin')) );
...
class Listing_Sidebar_Products_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
				...
				' ' . esc_html__( 'T &rarr; Listing', 'templatic') . '  ' . esc_html__('Products', 'templatic' ), // Name
				array(
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title:', 'templatic' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'subtitle' ); ?>"><?php esc_html_e( 'Subtitle:', 'templatic' ); ?></label>
