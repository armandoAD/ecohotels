...
class supreme_facebook extends WP_Widget {
	function supreme_facebook() {
		//Constructor
		$widget_ops = array('classname' => 't_facebook_fans', 'description' => __('Display a like box for your Facebook page. Works best in sidebar areas.','templatic-admin') );
		parent::__construct('supreme_facebook', __('T &rarr; Facebook Like Box','templatic-admin'), $widget_ops);
	}
...
<p>
  <label for="<?php echo $this->get_field_id('facebook_page_url'); ?>">
    <?php  echo __('Facebook Page Full URL','templatic-admin')?>
    :
...
<p>
  <label for="<?php echo $this->get_field_id('width'); ?>">
    <?php  echo __('Width','templatic-admin')?>
    :
...
<p>
  <label for="<?php echo $this->get_field_id('show_faces'); ?>">
    <?php  echo __('Show Faces','templatic-admin')?>
    :
...
<p>
  <label for="<?php echo $this->get_field_id('show_stream'); ?>">
    <?php  echo __('Show Stream','templatic-admin')?>
    :
...
<p id="facebook_show_header" <?php if(esc_attr($show_stream)=='1' || esc_attr($show_faces)=='1'){echo "style='display:block;'";}else{echo "style='display:none;'";}?>>
  <label for="<?php echo $this->get_field_id('show_header'); ?>">
    <?php  echo __('Show Header','templatic-admin')?>
    :
