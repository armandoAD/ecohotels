<?php // supreme_open_entry
	...
	if ( is_sticky() && is_home() && ! is_paged() ) : ?>
		<div class="featured-post">
		  <?php _e( 'Featured post', 'templatic' ); ?>
		</div>
	<?php 
	endif;
	...
	<div class="listing_img">
		<?php if($featured){echo '<span class="featured_tag">'; _e('Featured','templatic'); echo '</span>';} ?>
					...
					if(is_tevolution_active() && tmpl_donot_display_description()){ ?>
					  ...
					  <section class="entry-content">
						<?php 
							...
							wp_link_pages( array( 'before' => '<div class="page-links">' . __( 'Pages:', 'templatic' ), 'after' => '</div>' ) ); 
