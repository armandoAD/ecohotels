...
if(file_exists(get_stylesheet_directory().'/functions/auto_install/splendor-dummy-data.xml')){
	
	$xml_import->import(get_stylesheet_directory().'/functions/auto_install/splendor-dummy-data.xml');
	update_option('listing_xml',1);
	
	/* Add package for all sample listing */
	do_action('tmpl_add_sample_listing_package','listing');
}
?>